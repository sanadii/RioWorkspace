...
import { getClientSearch } from 'store/actions'; // Import your fetch action
...
const LiveSearch = <T extends object>({
  ...
  const handleChange: changeHandler = (e) => {
    ...
    if (e.target.value.length > 2) { // Add a condition to minimize unnecessary dispatches
        dispatch(getClientSearch(e.target.value));
      }

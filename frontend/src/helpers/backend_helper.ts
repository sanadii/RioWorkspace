...
export const updateRevenue = (dailyRevenue: any) =>
  api.update(url.UPDATE_REVENUE + "/" + dailyRevenue.id, dailyRevenue); //+ '/' + Revenue._id
...
export const addAppointmentService = (appointmentService: any) =>
  api.create(url.ADD_APPOINTMENT_SERVICE, appointmentService);
export const updateAppointmentService = (appointmentService: any) =>
  api.update(url.UPDATE_APPOINTMENT_SERVICE + "/" + appointmentService.id, appointmentService); //+ '/' + AppointmentService._id
export const deleteAppointmentService = (appointmentService: any) =>
  api.delete(url.DELETE_APPOINTMENT_SERVICE + "/" + appointmentService); //+ '/' + AppointmentService
...
export const updateOptionCategory = (optionCategory: any) =>
  api.update(url.UPDATE_OPTION_CATEGORY + "/" + optionCategory.id, optionCategory);
export const deleteOptionCategory = (optionCategory: any) =>
  api.delete(url.DELETE_OPTION_CATEGORY + "/" + optionCategory.id);
...
export const updateOptionChoice = (optionChoice: any) =>
  api.update(url.UPDATE_OPTION_CHOICE + "/" + optionChoice.id, optionChoice);

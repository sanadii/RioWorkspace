                  ...
                  <React.Fragment>
                    {(layoutType === layoutTypes.VERTICAL || layoutType === layoutTypes.HORIZONTAL) && (
                      <div id="layout-width">
                        ...
                        <p className="text-muted">Choose Wide, Fluid or Boxed layout.</p>
                          ...
                          <div className="col-4">
                            <div className="form-check card-radio">
                              <input
                                ...
                                id="layout-width-wide"
                                value={layoutWidthTypes.WIDE}
                                checked={layoutWidthType === layoutWidthTypes.WIDE}
                                onChange={(e) => {
                                  if (e.target.checked) {
                                    dispatch(changeLayoutWidth(e.target.value));
                                    dispatch(changeLeftsidebarSizeType("wide"));
                                  }
                                }}
                              />
                              <label className="form-check-label p-0 avatar-md w-100" htmlFor="layout-width-wide">
                                <span className="d-flex gap-1 h-100">
                                  <span className="flex-shrink-0">
                                    <span className="bg-light d-flex h-100 flex-column gap-1 p-1">
                                      <span className="d-block p-1 px-2 bg-primary-subtle rounded mb-2"></span>

...
const ExpenseDetails = () => {
  ...
  return (
    <div className="page-content">
      <Container fluid>
        <BreadCrumb title="Expense Details" pageTitle="Expenses" />
                  ...
                  <CardBody className="p-4">
                    <Row className="g-3">
                      <Col lg={3} xs={6}>
                        ...
                        <h5 className="fs-14 mb-0">#VL<span id="Expense-no">25000355</span></h5>
                      </Col>
                      <Col lg={3} xs={6}>
                        <p className="text-muted mb-2 text-uppercase fw-semibold">
                          Date
                        ...
                        <h5 className="fs-14 mb-0">
                          <span id="Expense-date">23 Nov, 2021</span> <small className="text-muted" id="Expense-time">02:36PM</small>
                        </h5>
                      </Col>
                      <Col lg={3} xs={6}>
                        <p className="text-muted mb-2 text-uppercase fw-semibold">
                      ...
                      <div className="alert alert-primary">
                        <p className="mb-0">
                          ...
                          <span id="note"> All accounts
                            are to be paid within 7 days from receipt of Expense. To

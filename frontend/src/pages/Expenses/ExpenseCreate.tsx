...
import { addExpense as onAddExpense } from "store/actions";
...
const ExpenseCreate = () => {
  ...
  const validation: any = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      ExpenseId: Yup.string().required("This field is required"),
  ...
  return (
    <div className="page-content">
      <Container fluid>
        <BreadCrumb title="Create Expense" pageTitle="Expenses" />
            ...
            <Card>
              ...
              >
                ...
                <CardBody className="p-4">
                  <Row className="g-3">
                    <Col lg={3} sm={6}>
                      <Label for="ExpenseoInput">Expense No</Label>
                      <Input
                        type="text"
                        className="form-control bg-light border-0"
                        id="ExpenseoInput"
                        name="ExpenseId"
                        value={validation.values.ExpenseId || ""}
                        onBlur={validation.handleBlur}
                        onChange={validation.handleChange}
                        placeholder="Expense No"
                        invalid={
                          validation.errors.ExpenseId &&
                          validation.touched.ExpenseId
                            ? true
                            : false
                        }
                      />
                ...
                <CardBody className="p-4">
                  <div className="table-responsive">
                    <Table className="Expense-table table-borderless table-nowrap mb-0">
                  ...
                  <div className="mt-4">
                    ...
                    <Input
                      ...
                      Expense. To be paid by cheque or credit card or direct

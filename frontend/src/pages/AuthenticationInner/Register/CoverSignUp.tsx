...
const CoverSignUp = () => {
    document.title = "Cover SignUp | Rio Brazil Salon - React Workspace";
                                        ...
                                        <Col lg={6}>
                                            <div className="p-lg-5 p-4">
                                                <div>
                                                    ...
                                                    <p className="text-muted">Get your Free Rio Brazil Salon account now.</p>
                                                </div>
                                                ...
                                                <Form
                                                        ...
                                                        <div className="mb-4">
                                                            <p className="mb-0 fs-12 text-muted fst-italic">By registering you agree to the Rio Brazil Salon <Link to="#" className="text-primary text-decoration-underline fst-normal fw-medium">Terms of Use</Link></p>
                                                        </div>
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="text-center">
                                    <p className="mb-0">{new Date().getFullYear()} Rio Brazil Salon. Crafted with <i className="mdi mdi-heart text-danger"></i> by Themesbrand</p>
                                </div>
                            </div>
                        </div>
                    </Container>

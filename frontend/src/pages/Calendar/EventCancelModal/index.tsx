...
const EventCancelModal = ({ isOpen, toggleModal, appointment }) => {
  ...
  return (
    ...
    >
      <ModalHeader toggle={toggleModal} tag="h5" className="booking-modal__header">
        Cancel Appointment
      </ModalHeader>
      ...
      <ModalFooter>
        <Button className="btn btn-padded btn-light" onClick={toggleModal}>
          Close
        </Button>
        <Button className="btn btn-padded btn-danger" name="commit" type="submit" onClick={toggleModal}>
          Cancel appointment
        </Button>
      </ModalFooter>
    </Modal>

...
import ServiceModal from "./AppointmentModal";
...
const ServiceList = () => {
  ...
  document.title = "Daily Appointment | Rio Brazil Salon Workspace";
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        ...
        <Container fluid>
          <BreadCrumb title="Daily Appointment" pageTitle="Daily Appointment" />
          <Row>
            <Col lg={12}>
              <Card id="service">

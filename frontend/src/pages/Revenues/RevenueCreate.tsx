...
import { addRevenue as onAddRevenue } from "store/actions";
...
const RevenueCreate = () => {
  ...
  const validation: any = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      RevenueId: Yup.string().required("This field is required"),
  ...
  return (
    <div className="page-content">
      <Container fluid>
        <BreadCrumb title="Create Revenue" pageTitle="Revenues" />
            ...
            <Card>
              ...
              >
                ...
                <CardBody className="p-4">
                  <Row className="g-3">
                    <Col lg={3} sm={6}>
                      <Label for="RevenueoInput">Revenue No</Label>
                      <Input
                        type="text"
                        className="form-control bg-light border-0"
                        id="RevenueoInput"
                        name="RevenueId"
                        value={validation.values.RevenueId || ""}
                        onBlur={validation.handleBlur}
                        onChange={validation.handleChange}
                        placeholder="Revenue No"
                        invalid={
                          validation.errors.RevenueId &&
                          validation.touched.RevenueId
                            ? true
                            : false
                        }
                      />
                ...
                <CardBody className="p-4">
                  <div className="table-responsive">
                    <Table className="Revenue-table table-borderless table-nowrap mb-0">
                  ...
                  <div className="mt-4">
                    ...
                    <Input
                      ...
                      Revenue. To be paid by cheque or credit card or direct
